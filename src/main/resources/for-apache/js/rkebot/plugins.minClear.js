function postars(canvas) {
	...
	_this.starsInterval = undefined;
    _this.init = function() {
        _this.setCanvas();
        _this.setContext();
		_this.starsInterval = setInterval(_this.createStars, 1000 / 30);
        _this.bind();
    };
	window.onresize = function() {
		//console.log("resized");
		if(!(_this.starsInterval==undefined)) {
			clearInterval(_this.starsInterval);
			_this.init();
		}
	};
    return _this;
